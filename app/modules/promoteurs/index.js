  ...
  <Content>
    <Grid className={"page-promoteurs"}>
      ...
      <Cell size={6} className={"section-4-1 paragraph"}>
        <p>
          De l&#39;etude, à la fabrication, à l&#39;installation,
          l&#39;entretien, le démontage en fin de contrat, ARROW est la solution
          efficace à la localisation de votre B.V..
        </p>
        <br />
        <p>
          Nos dispositifs sont installés sur le mobilier urbain existant, nous
          portons une attention particulière à sa protection et ce dans le
