    ...
    <Cell size={12} className={"section-3"}>
      <p>
        {`Nous avons mis au point un mobilier clair, efficace reconnaissable de
         tous à implanter en amont des établissements scolaire pour sensibiliser
      ...
      <p>
        ...
        dans toute la commune et feront parler d’eux.
          Leurs images sont faites pour marquer les esprits. Chaque fois que
          vous croiserez l’un d’entre eux, vous comprendrez qu’il y a une école
          à proximité.
          Ils sont recto-verso, ils transme􏰁ent donc plusieurs messages, qui peuvent
          aussi être des􏰀nés aux piétons.`}
      </p>
      <br />
